...
This repository contains a Next.js application located in /frontend and api server on express located on /api of this repository. When
...
* **Always use `npm run dev`** while iterating on the
...
* Prefer TypeScript (`.js`/`.jsx`) for new components and utilities.
